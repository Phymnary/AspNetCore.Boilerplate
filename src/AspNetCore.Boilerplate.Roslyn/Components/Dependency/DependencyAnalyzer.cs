...
public class DependencyAnalyzer : DiagnosticAnalyzer
{
    public override void Initialize(AnalysisContext context)
    {
        ...
        context.RegisterSyntaxNodeAction(AnalyzeAutoSyntax, SyntaxKind.ClassDeclaration);
    }
    ...
    private static void AnalyzeAutoSyntax(SyntaxNodeAnalysisContext context)
    {
        ...
        if (!classDeclarationNode.Modifiers.Any(SyntaxKind.PartialKeyword))
            builder.Add(DiagnosticDescriptors.ModuleMustBePartialForAuto, typeSymbol, typeName);
    ...
    public override ImmutableArray<DiagnosticDescriptor> SupportedDiagnostics { get; } =
        ImmutableArray.Create(
            DiagnosticDescriptors.InvalidClassDecorationForDependency,
            DiagnosticDescriptors.ModuleMustBePartialForAuto
        );
}